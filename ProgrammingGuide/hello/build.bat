...
set Pincludes=/I D:\dwp\dev\libs\SDL\SDL2-2.26.3\include /I D:\dwp\dev\libs\glew\glew-2.2.0\include
...
cl.exe /FC /Zi /nologo ..\*.cpp %Pincludes% /link /SUBSYSTEM:windows %Plibs%
popd